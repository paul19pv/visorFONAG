...
<div id="tab_rip_pas">
    ...
    <!--Simulación-->
    <div id="tab_rip_pas-4">
        <p class="w3-container w3-light-grey w3-round w3-padding-4">Esta sección permite visualizar cómo avanzan los procesos de restauración pasiva en el ecosistema ripario a través de la actividad cercado, mediante coberturas precargadas de los años 2008-2011, 2012, 2013, 2014 y 2015.</p>
        ...
        <div id="tab_rip_sim_pas">
            <ul>
                <li><a href="#tab_rip_sim_pas-1">Cercado</a></li>
            </ul>
            <div id="tab_rip_sim_pas-1">
