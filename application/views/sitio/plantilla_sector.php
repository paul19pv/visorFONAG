    ...
    <div id="tabs-4"><!--paramo-->
        ...
        <div id="tab_fas_par">
            ...
            <div id="tab_fas_par-1"><!--Activa-->
                <p class="w3-text-green w3-margin-top"><strong>A continuación puede encontrar las actividades y resultados por subactividad de la estrategia seleccionada:</strong></p>
                <div id="tab_act_par">
                    <ul>
                    ...
                    <div id="tab_act_par-1"><!--Plantación-->
                        <div class="w3-panel">
                            <div class="w3-display-container w3-col s4" style="height: 160px;">
                        ...
                        <p class="w3-text-green w3-margin-top"><strong>El estado de recuperación del sector seleccionado es el siguiente</strong></p>
                        <p class="w3-container w3-light-grey w3-round w3-padding-4"><strong>No existe información para este sector</strong></p>
                    </div>
                    <div id="tab_act_par-2"><!--Mantenimiento-->
                        ...
                        <p class="w3-text-green w3-margin-top"><strong> El estado de mantenimiento del sector seleccionado es el siguiente</strong></p>
                        <p class="w3-container w3-light-grey w3-round w3-padding-4"><strong>No existe información para este sector</strong></p>
                    </div>
                </div>
            </div><!--Activa Paramo-->
            <div id="tab_fas_par-2"><!--Pasiva Paramo-->
                <p class="w3-text-green w3-margin-top"><strong>A continuación puede encontrar las actividades y resultados por subactividad de la estrategia seleccionada:</strong></p>
                <div id="tab_pas_par">
                    <ul>
                    ...
                    <div id="tab_pas_par-1"><!--Cercado-->
                        <div class="w3-panel">
                            ...
                            <div class="w3-display-container w3-col s6" style="height:170px;">
                                <div class="w3-display-topmiddle">
                                    <table class="w3-table-all w3-centered">
                                        <thead>
                        ...
                        <div class="w3-light-grey w3-round w3-padding-8">
                            <form>
                                <div class="w3-row-padding w3-padding-8">
                                    ...
                                    <div class="w3-col s2">
                                        <input class="w3-input w3-border w3-round w3-padding-4" value="1050.00" readonly="readonly"/>
                                    </div>
                                    <div class="w3-col s2">
                                        <label class="w3-label w3-text-black">m</label>
                                    </div>
                                    <div class="w3-col s2">
                                        <input class="w3-input w3-border w3-round w3-padding-4" value="1.05" readonly="readonly"/>
                                    </div>
                                    <div class="w3-col s2">
                                ...
                                <div class="w3-row-padding w3-padding-8">
                                    ...
                                    <div class="w3-col s2">
                                        <input class="w3-input w3-border w3-round w3-padding-4" value="28.00" readonly="readonly"/>
                                    </div>
                                    <div class="w3-col s2">
                                        <label class="w3-label w3-text-black">Ha</label>
                                    </div>
                                    <div class="w3-col s2">
                                        <input class="w3-input w3-border w3-round w3-padding-4" value="0.28" readonly="readonly"/>
                                    </div>
                                    <div class="w3-col s2">
                        ...
                        <p class="w3-container w3-light-grey w3-round w3-padding-4">
                            En la Unidad Hidrográfica Antisana, sector la Mica, el FONAG ha realizado restauración pasiva con el cercado de alambre de Púas en 1.05 Km  que tienen influencia de protección sobre 28 ha de la Laguna La Mica en la Reserva Ecológica Antisana.
                        </p>
                    </div>
    ...
    <div id="tabs-6"><!--ripario-->
        ...
        <div id="tab_fas_rip">
            ...
            <div id="tab_fas_rip-2"><!--Pasiva-->
                <p class="w3-text-green w3-padding-8"><strong>A continuación puede encontrar las actividades y resultados por subactividad de la estrategia seleccionada:</strong></p>
                <div id="tab_pas_rip">
                    <ul>
                    ...
                    <div id="tab_pas_rip-2"><!--Mantenimiento-->
                        ...
                        <p class="w3-text-green w3-margin-top"><strong> El estado de mantenimiento del sector seleccionado es el siguiente:</strong></p>
                        <p class="w3-container w3-light-grey w3-round w3-padding-4"><strong>No existe información para sector</strong></p>
                    </div>
                </div>
            </div><!--Pasiva-->
        </div>
